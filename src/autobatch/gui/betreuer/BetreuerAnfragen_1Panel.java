		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(groupLayout.createSequentialGroup().addGroup(groupLayout
										...
										.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
												...
												.addGroup(groupLayout.createSequentialGroup()
														...
														.addGap(18)
														.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
																.addComponent(lblNameIN).addComponent(lblMNR)))))
								.addComponent(lblBeschreibung)).addPreferredGap(ComponentPlacement.RELATED))
						...
						.addGroup(groupLayout.createSequentialGroup().addContainerGap().addGroup(groupLayout
								...
								.addGroup(groupLayout.createSequentialGroup().addComponent(btnAnnehmen)
										.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnAblehnen)))))
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
						...
						.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE).addComponent(lblThemaIN)
								.addComponent(lblNewLabel).addComponent(lblMNR))
						.addGap(16).addComponent(lblBeschreibung).addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(lblBeschreibungIN).addGap(100)
						.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE).addComponent(btnAnnehmen)
